    ...
    <div className="relative min-h-screen">
      ...
      <footer className="bg-crust-dark text-flour py-20 px-6">
        ...
        <div className="max-w-6xl mx-auto mt-20 pt-8 border-t border-flour/10 flex flex-col md:flex-row justify-between items-center gap-6 text-[10px] uppercase font-bold tracking-widest text-flour/30">
          <p>© 2026 <span className="text-flour/60">Arte & Pan</span> | Created by <a href="https://nivopartners.com" target="_blank" rel="noopener noreferrer" className="inline-flex items-center ml-1 group hover:scale-105 transition-transform"><span className="text-white font-black tracking-widest">NIVO</span><span className="text-blue-500 font-black tracking-widest ml-1">PARTNERS</span></a></p>
